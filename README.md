...
**Tribute** is a pair project built by two strangers who met online, and explored pair programming.
...
```sh
 $ cd my-folder
 $ git clone git@github.com:mutugi-c/tribute.git
```
...
To run the project have Node.js installed, and execute the following command:
...
- GitHub: [@MustafaSamiShirzad](https://github.com/MustafaSamiShirzad)
